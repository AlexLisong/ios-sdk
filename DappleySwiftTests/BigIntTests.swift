...
class BigIntTests: XCTestCase {
    ...
    func testInit() {
        XCTAssertEqual(BigInt(17), 17)
        XCTAssertEqual(BigInt("17"), 17)
        let bigInt = BigInt(15)
        let data = Data("15".utf8)
        XCTAssertEqual(Data(String(bigInt).utf8), data)
        XCTAssertEqual(bigInt, BigInt(String(data: data, encoding: String.Encoding.utf8)!))

       // XCTAssertEqual(Data(str: String(BigInt("15"))), Data(str: "15"))
