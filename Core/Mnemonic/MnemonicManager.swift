...
public final class MnemonicManager {
    ...
    public static func create(strength: Strength = .normal, language: WordDict = .english) -> [String] {
    ...
    public static func create(entropy: Data, language: WordDict = .english) -> [String] {
    ...
    public static func createSeed(mnemonic: [String], withPassphrase passphrase: String = "") throws -> Data {
        let words = WordDict.english.words + WordDict.chinese.words
